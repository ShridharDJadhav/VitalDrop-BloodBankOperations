...
//		
//		auth.userDetailsService(userDetailsService).encoder(encoder);
//	}
...
//	}
	...
	protected void configure(HttpSecurity http) throws Exception {
	    http.cors()
	        ...
	        .antMatchers("/api/bloodbank/**", "/api/auth/**", "/users/**").permitAll() 
	 ...
	 @Bean
	    public CorsConfigurationSource corsConfigurationSource() {
	        ...
	        configuration.setAllowedOrigins(Arrays.asList("https://vitaldrop-90yy.onrender.com","https://vitaldrop-bloodbankoperations.vercel.app")); // Replace with your frontend URL
