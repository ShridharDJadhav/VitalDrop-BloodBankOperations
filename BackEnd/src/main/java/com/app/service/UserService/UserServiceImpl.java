...
//		List<User> content = page.getContent();
	...
	// by this method we can retrieve the data of user as well as identity proof
	// data aslo, by join querry
	@Override
...
//	}
	...
	public User storeImage(Long id, MultipartFile imageFile) {
		User findById = userDao.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("used does not exists!!!"));
