...
//     return isLoggedIn() ? userDetails : undefined;
//   };
...
//             {!login && (
//               <NavItem>
//                 <NavLink tag={ReactLink} to="/login">Need Blood</NavLink>
//               </NavItem>
//             )}
...
//                 <NavItem>
//                   <NavLink tag={ReactLink} to="/adminhome">{user.email}</NavLink>
//                 </NavItem>
...
//                 <NavItem>
//                   <NavLink tag={ReactLink} to="/userhome">{user.email}</NavLink>
//                 </NavItem>
